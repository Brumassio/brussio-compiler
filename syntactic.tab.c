...
static const char *const yytname[] =
{
  ...
  "UMINUS", "','", "'('", "')'", "'!'", "'{'", "'}'", "$accept",
  "declarations", "declaration", "type", "names", YY_NULLPTR
};
